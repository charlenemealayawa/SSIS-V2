...
root.title('Student Information System (Layawa)')
root.state('zoomed')
...
mainFrame = LabelFrame(root, bg="white", highlightbackground="white",highlightthickness=4)
mainFrame.place(x=468,y=100,height=575,width=885)

mainFrame2 = LabelFrame(root, bg="white",highlightbackground="white",highlightthickness=4)
mainFrame2.place(x=8,y=100,height=575,width=450)

Label(root, text="STUDENT INFORMATION SYSTEM", font = ('Britannic Bold', 50, 'bold'),fg="black",bg= "white", width=32).pack(side=TOP,fill=X)   
Label(mainFrame, text="STUDENT LIST", font = ('Apple SD Gothic Neo', 30, 'bold'),fg="black",bg="white", width=34).grid(row=0,column=0, columnspan=6)
Label(mainFrame2, text="COURSES LIST", font = ('Apple SD Gothic Neo', 30, 'bold'),fg="black",bg="white", width=15).grid(row=0,column=0, columnspan=6)

mydb = sqlite3.connect('SSISV2 (Layawa).db')
...
def addCourse():
    ...
    SecDataFrame = Frame(SecondFrame,bd=1, width=1300, height=400, padx=20, pady=20, bg ="white")
    SecDataFrame.pack(side=BOTTOM)
    
    CourseInf=LabelFrame(SecDataFrame, width=1000, height=600, padx=20, bg="white", font=('Apple SD Gothic Neo ',20,'bold'),text="Course Information", fg="black")
    CourseInf.pack(side=LEFT)
    
    Cno.set("")
    Cname.set("")
    
    Ccode = Label(CourseInf,text="Course Code ",font=('Apple SD Gothic Neo',13, 'bold'), padx=2, pady=2, bg="white", fg="black",)
    ...
    CName = Label(CourseInf, font=('Apple SD Gothic Neo',13, 'bold'),text="Course Name ", padx=2, pady=2, bg="white", fg="black")
    ...
    AddCourse=Button(CourseInf, text="ADD COURSE", command=addCourseData,font=('Apple SD Gothic Neo', 15,'bold'), bg="white", fg="black")
...
def updateCourse(index):
    ...
    CourseSubmit=Button(DataCAdd, text="UPDATE", command=lambda:thisUpdateCourse(CourseInfo), font=('Apple SD Gothic Neo', 15,'bold'), bg="white", fg="black")
...
searchbutton2 = Button(mainFrame2, text="SEARCH",font=('Apple SD Gothic Neo', 9,'bold'), bg="white", fg="black", width=12,command=searchCourse)
searchbutton2.grid(row=2, column=0, padx=6, pady=5)
    
viewButton2 = Button(mainFrame2, text="VIEW ALL", command=viewCourseList,font=('Apple SD Gothic Neo', 9,'bold'), bg="white", fg="black",width=12)
viewButton2.grid(row=1, column=0, padx=6, pady=5)

addButton2 = Button(mainFrame2, text="ADD COURSE", font=('Apple SD Gothic Neo', 9,'bold'), bg="white", fg="black",width=16,command=addCourse)
addButton2.grid(row=1, column=3, padx=4, pady=5)
    
edit2 = Button(mainFrame2, text="EDIT",font=('Apple SD Gothic Neo', 9,'bold'), bg="white", fg="black", width=11, command=lambda:updateCourse(treeSec.focus()))
edit2.grid(row=1, column=2, padx=6, pady=5)
    
delete2 = Button(mainFrame2, text="DELETE",font=('Apple SD Gothic Neo', 9,'bold'), bg="white", fg="black", width=12,command=deleteCourse)
...
def clicked(*args):
    ...
    if len(this) != 0 or there == True:
        def add():
            ...
            MainFrame = Frame(top, bg="white")
            MainFrame.grid()
            
            DataFrame = Frame(MainFrame,bd=1, width=1300, height=400, padx=20, pady=20, bg ="white")
            DataFrame.pack(side=BOTTOM)
            
            StudInf=LabelFrame(DataFrame, width=1000, height=600, padx=20, bg="white", font=('Apple SD Gothic Neo',20,'bold'),text="Student's Information", fg="black")
            ...
            SILabel = Label(StudInf, font=('Apple SD Gothic Neo',13, 'bold'),text="Student ID  ", padx=2, pady=2, bg ="white", fg="black")
            ...
            FLabel = Label(StudInf, font=('Apple SD Gothic Neo',13, 'bold'),text="Name", padx=2, pady=2,  bg ="white", fg="black")
            ...
            CLabel = Label(StudInf, font=('Apple SD Gothic Neo',13, 'bold'),text="Course ", padx=2, pady=2, bg ="white", fg="black")
            ...
            YLabel = Label(StudInf, font=('Apple SD Gothic Neo',13, 'bold'),text="Year Level ", padx=2, pady=2,  bg ="white", fg="black")
            ...
            GLabel = Label(StudInf, font=('Apple SD Gothic Neo',13, 'bold'),text="Gender ", padx=2, pady=2,  bg ="white", fg="black")
            ...
            addstudent=Button(StudInf, text="ADD STUDENT",command=addData, font=('Apple SD Gothic Neo', 15,'bold'),  bg ="white", fg="black")
        ...
        def update(index):
            ...
            DataFrame2 = Frame(MainFrame2,bd=1, width=1300, height=400, padx=20, pady=20, bg ="white")
            DataFrame2.pack(side=BOTTOM)
                    
            DataAdd2=LabelFrame(DataFrame2, width=1000, height=600, padx=20, bg="white", font=('Palatino Linotype',20,'bold'),text="Student's Information", fg="black")
            DataAdd2.pack(side=LEFT)
                    
            SILable = Label(DataAdd2, font=('Apple SD Gothic Neo',13, 'bold'),text="Student ID  ", padx=2, pady=2, bg ="white", fg="black")
            SILable.grid(row=0, column=0, sticky=W)
            ID = Entry(DataAdd2, font=('Apple SD Gothic Neo',13),textvariable=StdID, width=39)
            ID.grid(row=0, column=1, pady=8)
                    
            FLabel = Label(DataAdd2, font=('Apple SD Gothic Neo',13, 'bold'),text="Name  ", padx=2, pady=2, bg ="white", fg="black")
            FLabel.grid(row=1, column=0, sticky=W)
            name = Entry(DataAdd2, font=('Apple SD Gothic Neo',13),textvariable=Name, width=39)
            name.grid(row=1, column=1, pady=8)
                    
            CLabel = Label(DataAdd2, font=('Apple SD Gothic Neo',13, 'bold'),text="Course ", padx=2, pady=2, bg ="white", fg="black")
            CLabel.grid(row=2, column=0, sticky=W)
            course = Entry(DataAdd2, font=('Apple SD Gothic Neo',13),textvariable=Course, width=39)
            course.grid(row=2, column=1, pady=8)
                    
            YLabel = Label(DataAdd2, font=('Apple SD Gothic Neo',13, 'bold'),text="Year Level ", padx=2, pady=2,  bg ="white", fg="black")
            YLabel.grid(row=3, column=0, sticky=W)
            ylevel = Entry(DataAdd2, font=('Apple SD Gothic Neo',13),textvariable=YearLevel, width=39)
            ylevel.grid(row=3, column=1, pady=8)

            GLabel = Label(DataAdd2, font=('Apple SD Gothic Neo',13, 'bold'),text="Gender ", padx=2, pady=2,  bg ="white", fg="black")
            GLabel.grid(row=4, column=0, sticky=W)
            gender = Entry(DataAdd2, font=('Apple SD Gothic Neo',13),textvariable=Gender, width=39)
            gender.grid(row=4, column=1, pady=8)

            update=Button(DataAdd2, text="UPDATE", command=lambda:thisUpdate(studentInfo), font=('Apple SD Gothic Neo', 15,'bold'), bg ="white", fg="black")
        ...
        searchbutton = Button(mainFrame, text="SEARCH",font = ('Apple SD Gothic Neo', 9, 'bold'),fg="black",bg= "white", width=13, command=search)
        searchbutton.grid(row=1, column=1, padx=6, pady=5)
            
        viewButton = Button(mainFrame, text="VIEW LIST", font = ('Apple SD Gothic Neo', 9, 'bold'),fg="black",bg= "white",width=13, command=viewAll)
        viewButton.grid(row=1, column=3, padx=6, pady=5)

        addButton = Button(mainFrame, text="ADD STUDENT", font = ('Apple SD Gothic Neo', 9, 'bold'),fg="black",bg= "white",width=16, command=add)
        addButton.grid(row=1, column=2, padx=6, pady=5)
            
        edit = Button(mainFrame, text="EDIT", font = ('Apple SD Gothic Neo', 9, 'bold'),fg="black",bg= "white", width=13, command=lambda:update(tree.focus()))
        edit.grid(row=1, column=5, padx=6, pady=5)
            
        delete = Button(mainFrame, text="DELETE",font = ('Apple SD Gothic Neo', 9, 'bold'),fg="black",bg= "white", width=13, command=delete)
